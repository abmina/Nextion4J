 ...
 */
public class NexNumber extends NexTouch{
     ...
     * @param name 
     */
    public NexNumber(int pid, int cid, String name){
        super(pid, cid, name);
    }
    
    /**
     * gets the value of the number box
     * 
     * @return the "val" attribute of the number
     * @throws Exception 
     */
    ...
    /**
     * used to set the value of the number box
     * 
     ...
     * 
     * @return the "lenth" attribute of the number
     * @throws Exception 
     */
    public int getNumberLength() throws Exception{
        String cmd;
        cmd = "get " + getObjName() + ".lenth";
        nex.sendCommand(cmd);
        return nex.receiveInt();
    }
    
    /**
     * used to set length of the number.
     * 
     * @param length is the length of the number that will be set
     * @return true if the command was finished successfully.
     * @throws Exception 
     */
    public boolean setNumberLength(int length) throws Exception{
        String cmd;
        cmd = getObjName() + ".lenth=" + length;
        nex.sendCommand(cmd);
