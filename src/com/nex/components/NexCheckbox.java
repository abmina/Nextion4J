 ...
 */
public class NexCheckbox extends NexTouch{
        
    /**
     * NexCheckbox constructor with:
     * @param pid page ID
     * @param cid component ID
     * @param name component name
     */
    public NexCheckbox(int pid, int cid, String name){
        super(pid, cid, name);       
    }
    
    /**
     * gets the value either the checkbox is selected or not
     * 
     * @return the "val" attribute of the checkbox
     * @throws Exception 
     */
    ...
    /**
     * used to set the state of the checbox
     * 
    ...
    /**
     * used to get the check color of the checkbox
     * 
     * @return the "pco" attribute color integer value
     * @throws Exception 
     */
    public int getCheckColor() throws Exception{
        String cmd;
    ...
    /**
     * used to set check color of the checkbox
     * 
     * @param color is the color integer value to change the "pco" attribute
     * @return true if the command was finished successfully.
     * @throws Exception 
     */
    public boolean setCheckColor(int color) throws Exception{
        String cmd;
